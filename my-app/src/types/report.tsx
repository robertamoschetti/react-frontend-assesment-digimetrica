export interface Report {
    ...
    // Dettagli numerici
    n_port: { [port: string]: number }; // Numero di esposizioni per ciascuna porta
    ...
    waf: {
      protected_assets: number; // Numero di asset protetti dal WAF
      waf_provider: string; // Nome del provider WAF
    };
  
    // Dettagli sul CDN (Content Delivery Network)
    cdn: {
      enabled: boolean; // Indica se il CDN è abilitato
      provider: string; // Nome del provider CDN
    };
  }
